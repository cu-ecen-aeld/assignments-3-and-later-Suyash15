...
cp -a ${SYSROOT_PATH}/lib/ld-linux-aarch64.so.1 ${OUTDIR}/rootfs/lib/
cp -a ${SYSROOT_PATH}/lib64/libm.so.6 ${OUTDIR}/rootfs/lib64/
cp -a ${SYSROOT_PATH}/lib64/libresolv.so.2 ${OUTDIR}/rootfs/lib64/
cp -a ${SYSROOT_PATH}/lib64/libc.so.6 ${OUTDIR}/rootfs/lib64/
...
cd "/home/kinshu/course/assignment-1-Suyash15/finder-app"
make clean
